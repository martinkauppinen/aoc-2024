...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `49.4µs` | `52.8µs` |
| [Day 2](./src/bin/02.rs) | `144.1µs` | `213.4µs` |
| [Day 3](./src/bin/03.rs) | `251.5µs` | `251.1µs` |
| [Day 4](./src/bin/04.rs) | `134.3µs` | `92.3µs` |
| [Day 5](./src/bin/05.rs) | `136.3µs` | `207.9µs` |
| [Day 6](./src/bin/06.rs) | `69.0µs` | `25.6ms` |
| [Day 7](./src/bin/07.rs) | `1.1ms` | `2.0ms` |
| [Day 8](./src/bin/08.rs) | `40.4µs` | `106.5µs` |
| [Day 9](./src/bin/09.rs) | `521.9µs` | `8.5ms` |
| [Day 10](./src/bin/10.rs) | `510.8µs` | `461.5µs` |
| [Day 11](./src/bin/11.rs) | `490.0µs` | `10.2ms` |
